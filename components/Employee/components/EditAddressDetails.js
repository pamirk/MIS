...
function EditAddressDetails({itemkey, handleCancel, hideHandler, id, data, form}) {
        ...
        <div className='p-5'>
            <Form layout='vertical' onSubmit={handlerSubmit} {...formItemLayout} >
                ...
                <FormItem label="Phone Number">{
                    getFieldDecorator('phone_number', {rules: [{required: true, message: "Phone Number is required"}]
...
export default Form.create()(EditAddressDetails);
